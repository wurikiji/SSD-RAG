    ...
    with open(self.query_file) as f:
      ...
      for line in tqdm(lines):
          ...
          if self.use_past_cache:
            ...
            print(f"cache read {cache_read_interval} seconds", flush=True)
            ...
            print(f"cache load {cache_interval} seconds", flush=True)
          ...
          interval = end - start
          print(f"{interval} seconds", flush=True)
          elapsed += interval
      print(f"Avg elapsed time: {elapsed / len(lines)}", flush=True)
      print(f"Avg cache load: {cache_elapsed / len(lines)}", flush=True)
